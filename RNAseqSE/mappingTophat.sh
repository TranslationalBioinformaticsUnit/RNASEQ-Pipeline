...
/opt/tophat-2.1.1.Linux_x86_64/tophat2 --no-coverage-search  -G $Reference_Dir/Homo_sapiens38.gtf -o $Output_Dir/$FastqID $Reference_Dir/Homo_sapiens38 $Input_Dir/${FastqID}_trimmed.fastq
